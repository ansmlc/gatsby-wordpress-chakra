...
import { BaseLayout } from '../features/rootLayout';
...
export const query = graphql`
  query ($slug: String!) {
    allWpPost(filter: { author: { node: { slug: { eq: $slug } } } }, limit: 9) {
      edges {
        node {
          ...postFields
          author {
